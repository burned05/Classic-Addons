...
StubbyConfig = {
	["addinfo"] = {
		["Enchantrix"] = "Enchantrix|Display information in item tooltips pertaining to disenchanting, prospecting, and milling results.  [2.5.6768] This AddOn is licensed under the GNU GPL, see GPL.txt for details.",
